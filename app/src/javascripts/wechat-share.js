...
module.exports = {
    init: function() {
        ...
        var fenxiangJson_data = {
            ...
            desc: '保乐力加中国\r\n薪酬福利体系H5方案-乐生活club', // 分享描述
            link: 'http://http://html.quantify.site/dist', // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
            imgUrl: 'http://http://html.quantify.site/dist/images/logo.png', // 分享图标
            success: function () {
                // 设置成功
            }
        };
